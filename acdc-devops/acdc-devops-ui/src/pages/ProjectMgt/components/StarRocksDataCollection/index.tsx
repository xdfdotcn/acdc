  ...
  const ref = useRef<ActionType>();
	...
	return (
      <ProTable<API.DataSystemResource, API.DataSystemResourceQuery>
          ...
          return {
            onClick: () => {
              ...
              setStarRocksDatasetModel({
                ...
                clusterResourceId: starRocksDatasetModel.clusterResourceId,
        ...
        params={{
          parentResourceId: starRocksDatasetModel.clusterResourceId,
          resourceTypes: [DataSystemResourceTypeConstant.STARROCKS_DATABASE],
        ...
        toolBarRender={() => [
          <Button.Group key="refs" style={{display: 'block'}}>
            <Button
              ...
              onClick={async () => {
                setRefresh(true)
                await refreshDynamicDataSystemResource(starRocksDatasetModel.clusterResourceId)
                ref.current?.reload();
                setRefresh(false)
              }}>
              刷新 database + table
...
const TableList: React.FC = () => {
	...
	const {starRocksDatasetModel} = useModel('StarRocksDatasetModel')
	...
	return (
		<ProTable<API.DataSystemResource, API.DataSystemResourceQuery>
			...
			params={{
        parentResourceId: starRocksDatasetModel.databaseResourceId,
				name: queryTableName
			}}
			request={pagedQueryDataSystemResource}
