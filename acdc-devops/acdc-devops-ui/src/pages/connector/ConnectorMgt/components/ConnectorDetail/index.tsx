...
const SinkDetail: React.FC<{ connectorDetail: API.ConnectorDetail }> = ({ connectorDetail }) => {
  ...
  return (
    <>
      ...
      >
        <Descriptions column={2}>
          <Descriptions.Item label="名称">
            <Field text={connectorDetail.name} mode="read" />
          </Descriptions.Item>
          <Descriptions.Item label="运行状态">
            <Field text={connectorDetail.actualState} mode="read" />
          </Descriptions.Item>
        </Descriptions>
      </ProCard>
      ...
      <ProCard title="目标端信息" headerBordered collapsible onCollapse={(collapse) => {}}>
        <Descriptions column={2}>
          <Descriptions.Item label="集群">
...
const SourceDetail: React.FC<{ connectorDetail: API.ConnectorDetail }> = ({ connectorDetail }) => {
  ...
  return (
    <>
      ...
      <ProCard title="源端信息" headerBordered collapsible onCollapse={(collapse) => {}}>
        <Descriptions column={2}>
          <Descriptions.Item label="集群">
      ...
      <ProCard title="目标端信息" headerBordered onCollapse={(collapse) => {}}>
...
const ConnectorDetail: React.FC<{ connectorId: number }> = ({ connectorId }) => {
  ...
  return (
    ...
    >
      <ProCard.TabPane key="tab1" tab="任务详情">
        {getConnectorDetailPage()}
      </ProCard.TabPane>

      <ProCard.TabPane key="tab2" tab="任务配置">
