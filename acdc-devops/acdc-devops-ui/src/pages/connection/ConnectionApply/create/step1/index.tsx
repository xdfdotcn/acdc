...
import {pagedQueryProject, pagedQueryDataSystemResource} from '@/services/a-cdc/api';
...
const ProjectList: React.FC = () => {
  ...
  return (
    <ProTable<API.Project, API.ProjectQuery>
        ...
        return {
          onClick: () => {
            ...
            let newModel={
              ...
              srcPrjOwnerName: record.ownerName,
            }
      ...
      params={{
        name: projectName,
        queryRange: ProjectConstant.QUERY_RANGE_ALL
      }}
      // 请求数据API
