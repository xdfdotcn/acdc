...
public class KafkaTopicServiceImplIT {
    ...
    private KafkaTopicDetailDTO createKafkaTopicDetail() {
        ...
        return KafkaTopicDetailDTO.builder()
                .kafkaClusterId(kafkaClusterDO.getId())
                .dataSystemResourceId(tableDO.getId())
    ...
    private List<KafkaTopicDetailDTO> createKafkaTopicDetailLimit3() {
        ...
        return Lists.newArrayList(
                KafkaTopicDetailDTO.builder()
                        .kafkaClusterId(kafkaClusterDO.getId())
                        .dataSystemResourceId(tableDO1.getId())
                        .name("test_kafka_topic1")
                        .build(),
                KafkaTopicDetailDTO.builder()
                        .kafkaClusterId(kafkaClusterDO.getId())
                        .dataSystemResourceId(tableDO2.getId())
                        .name("test_kafka_topic2")
                        .build(),
                KafkaTopicDetailDTO.builder()
                        .kafkaClusterId(kafkaClusterDO.getId())
                        .dataSystemResourceId(tableDO3.getId())
                        .name("test_kafka_topic3")
                        .build()
        );
    }
