...
class TestHelper {
    ...
    static final UsernameAndPassword U_PASSWORD = new UsernameAndPassword("es", EncryptUtil.encrypt("123"));
    ...
    static DataSystemResourceDetailDTO createClusterRsDetal() {
        ...
        config.put(
                ...
                new DataSystemResourceConfigurationDTO()
                        ...
                        .setValue(U_PASSWORD.getUsername())
        );
        config.put(
                ...
                new DataSystemResourceConfigurationDTO()
                        ...
                        .setValue(U_PASSWORD.getPassword())
        );
