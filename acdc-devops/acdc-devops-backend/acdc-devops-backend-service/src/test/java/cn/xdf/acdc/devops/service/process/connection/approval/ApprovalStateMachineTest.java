...
//        when(applicationContext.getBean(DefaultApprovalEventConverter.class)).thenReturn(new DefaultApprovalEventConverter());
//        when(applicationContext.getBean(IgnoreAnyOperationAndSkipRemainApprovalEventConverter.class)).thenReturn(new IgnoreAnyOperationAndSkipRemainApprovalEventConverter());

//        when(approvalStateMachineContext.loadDbaApprover(any())).thenReturn(Lists.newArrayList(
//                DomainUserDTO.toDomainUserDTO("test@xx.cn")
//        ));
//        when(approvalStateMachineContext.loadSourceOwner(any())).thenReturn(Lists.newArrayList(
//                DomainUserDTO.toDomainUserDTO("test@xx.cn")
//        ));
//        when(approveStateMachineContext.loadProposer(any())).thenReturn(Lists.newArrayList(
//            DomainUserDTO.toDomainUserDTO("test@xx.cn")
//        ));
    }
