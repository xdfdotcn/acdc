...
public class Jdbc2HiveFieldMappingServiceImplTest {
    ...
    public void testSupportSinkAppTypes() {
        ...
        Assertions.assertThat(dataSystemTypes).contains(DataSystemType.HIVE);
    }

//    @Test
//    public void testSinkConnectDataSystemType() {
//        DataSystemType2 dataSystemType = fieldMappingService.sinkConnectDataSystemType();
//        Assertions.assertThat(DataSystemType2.HIVE).isEqualTo(dataSystemType);
//    }
    ...
    public void testNewSequence() {
        ...
        String expect = new StringBuilder()
            ...
            .append(FieldKeyType.UNI.getSort()).toString();
