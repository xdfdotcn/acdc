...
@Service
public class Jdbc2StarRocksConnectionColumnConfigurationGenerator implements ConnectionColumnConfigurationGenerator {
    ...
    public Set<DataSystemType> supportedSinkDataSystemTypes() {
        return Sets.immutableEnumSet(DataSystemType.STARROCKS);
    }
}
