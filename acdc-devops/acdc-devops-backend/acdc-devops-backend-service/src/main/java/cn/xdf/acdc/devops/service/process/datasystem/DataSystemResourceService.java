...
public interface DataSystemResourceService {
    ...
    /**
     * Get data system resource path by id.
     *
     * <p>ordering rule: From the root node to the current node
     *
     * <p>eg: [mysql_cluster1,database1,table1], corresponding path: mysql_cluster1/database1/table1
     *
     * @param resourceId resource id
     * @return an ordered list of resource paths
     */
    List<DataSystemResourceDTO> getPathById(Long resourceId);
     ...
     *
     * <p>e.g. parent is cluster and all instances in the cluster as the param in this function, merge action means new instance's insert, exist ones' updated, removed ones' deleted
     *
     * <p>cautions: every sensitive configuration value will be encrypt before save.
     *
     ...
     *
     * <p>e.g. parent is cluster and all instances in the cluster as the param in this function,
     * merge action means new instance's insert, exist ones' updated, removed ones' deleted
     *
     * <p>cautious: configurations will not be merged in existed resource,
     ...
     *
     * <p>Before save, we will check resource configuration is valid.
     *
     * <p>cautions: every sensitive configuration value will be encrypt before save.
     *
