...
public class ApiKafkaClusterCommand implements Command<ApiKafkaClusterCommand.CommandEntity> {
    ...
    private Map<String, Object> doCreate(final CommandEntity entity) {
        ...
        KafkaClusterDTO kafkaCluster = kafkaClusterService.create(
                new KafkaClusterDTO()
                        .setBootstrapServers(entity.bootstrapServer)
                        .setClusterType(entity.clusterType)
                        .setDescription(entity.clusterType.name())
                        .setName(entity.clusterType.name())
                        .setSecurityProtocol(entity.securityProtocol)
                        .setSaslMechanism(entity.saslMechanism)
                        .setSaslUsername(entity.saslUsername)
                        .setSaslPassword(entity.saslPassword)
                        .setVersion(entity.kafkaVersion),
                securityConfig
        );
