...
public class AbstractInformerTest {
    ...
    public void testWaitForInitializedShouldThrowTimeOutExceptionWithTimeout() throws InterruptedException, TimeoutException {
        AbstractFixedRateRunnableInformer<Integer> abstractInformer = fakeAbstractInformer();
    ...
    public void testWaitForInitializedShouldWaitUntilInitialized() throws InterruptedException {
        ...
        new Thread(() -> {
            try {
                abstractInformer.waitForInitialized(AbstractFixedRateRunnableInformer.DEFAULT_INFORMER_INITIALIZATION_TIMEOUT_IN_SECONDS, TimeUnit.SECONDS);
    ...
    private AbstractFixedRateRunnableInformer<Integer> fakeAbstractInformer() {
        return new TestInformer(scheduler);
    }
    
    static class TestInformer extends AbstractFixedRateRunnableInformer<Integer> {
