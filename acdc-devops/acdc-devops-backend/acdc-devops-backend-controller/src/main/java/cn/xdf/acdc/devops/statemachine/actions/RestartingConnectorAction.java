...
public class RestartingConnectorAction extends UpdateStateToDbAction {
    ...
    public RestartingConnectorAction(final ConnectClusterRest connectClusterRest, final ConnectorCoreProcessService connectorCoreProcessService) {
    ...
    public void execute(final ConnectorState from, final ConnectorState to, final ConnectorEvent event, final ConnectorInfoDTO connectorInfoDTO, final ConnectorStateMachine stateMachine) {
        connectClusterRest.restartConnectorAndTasks(connectorInfoDTO.getConnectClusterUrl(), connectorInfoDTO.getName());
