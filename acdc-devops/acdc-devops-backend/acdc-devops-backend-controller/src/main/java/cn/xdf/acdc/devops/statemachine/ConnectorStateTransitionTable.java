...
public enum ConnectorStateTransitionTable {
    ...
    STOPPING_ON_STOP_SUCCESS_TO_STOPPED(ConnectorState.STOPPING, ConnectorState.STOPPED, ConnectorEvent.STOP_SUCCESS, UpdateStateToDbAction.class, EventLevel.INFO, "connector is stopped."),
    ...
    /**
     * Construct an instance with all args.
     *
     ...
     */
    ConnectorStateTransitionTable(
            final ConnectorState from,
            final ConnectorState to,
