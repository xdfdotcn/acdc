...
public class DateToString implements Transformation<SinkRecord> {
    ...
    private static final Set<String> TO_TRANSFER_SCHEMA_NAMES = new HashSet<>();
    
    private String zonedTimestampFormatter;
    
    static {
        TO_TRANSFER_SCHEMA_NAMES.add(Date.LOGICAL_NAME);
        TO_TRANSFER_SCHEMA_NAMES.add(Time.LOGICAL_NAME);
        TO_TRANSFER_SCHEMA_NAMES.add(Timestamp.LOGICAL_NAME);
        TO_TRANSFER_SCHEMA_NAMES.add(ZONED_TIMESTAMP_LOGICAL_NAME);
    }
