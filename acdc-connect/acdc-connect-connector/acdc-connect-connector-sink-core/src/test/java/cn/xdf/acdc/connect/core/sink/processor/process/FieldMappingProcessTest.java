...
public class FieldMappingProcessTest {
    ...
    public void shouldMappingAllFields() {
        ...
        Assert.assertTrue(fieldAndValues.get("new_filed_name_1").getValue().equals("value_1"));
        Assert.assertTrue(fieldAndValues.get("new_filed_name_2").getValue().equals("value_2"));
        Assert.assertTrue(fieldAndValues.get("new_filed_name_3").getValue().equals("value_3"));
    }
    ...
    public void shouldNotMappingAllFields() {
        ...
        Assert.assertEquals(fieldAndValues.size(), 3);
        Assert.assertTrue(fieldAndValues.get("filed_name_4").getValue().equals("value_1"));
        Assert.assertTrue(fieldAndValues.get("filed_name_5").getValue().equals("value_2"));
        Assert.assertTrue(fieldAndValues.get("filed_name_6").getValue().equals("value_3"));
    }
