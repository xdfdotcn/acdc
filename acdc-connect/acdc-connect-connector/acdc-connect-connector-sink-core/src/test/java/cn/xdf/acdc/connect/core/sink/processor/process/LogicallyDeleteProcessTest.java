...
public class LogicallyDeleteProcessTest {
    ...
    public void shouldDelete() {
        ...
        Assert.assertEquals(fieldAndValues.size(), 5);
        Assert.assertEquals("1", fieldAndValues.get("is_delete").getValue());
    }
    ...
    public void shouldNotDeleteWhenDeleteSignalFieldNotExisted() {
        ...
        Assert.assertFalse(fieldAndValues.containsKey("is_delete"));
    }
