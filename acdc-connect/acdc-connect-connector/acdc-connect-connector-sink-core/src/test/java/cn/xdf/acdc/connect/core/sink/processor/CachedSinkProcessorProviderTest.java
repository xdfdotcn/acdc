...
public class CachedSinkProcessorProviderTest {
    ...
    public void shouldGetProcessor() {
        ...
        Assert.assertTrue(Objects.nonNull(table1SinkSingleRecordProcessor));
        Assert.assertTrue(Objects.nonNull(table2SinkSingleRecordProcessor));
    }
    ...
    public void shouldGetCachedProcessor() {
        ...
        Assert.assertEquals(table1CachedSinkSingleRecordProcessor, table1SinkSingleRecordProcessor);
    }
