...
public final class SinkSchemaBigint implements SinkSchema {

    private static final Set<Type> TYPES = Sets.immutableEnumSet(Type.INT8, Type.INT16, Type.INT32, Type.INT64);

    private static final SinkSchema INSTANCE = new SinkSchemaBigint();
