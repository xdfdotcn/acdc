...
public final class SinkSchemaBoolean implements SinkSchema {

    private static final SinkSchema INSTANCE = new SinkSchemaBoolean();

    /**
     * Get the singleton instanceDateTimeUtils.
     * @return SinkSchema
     */
    ...
    public boolean isCompatibility(final Schema source) {
        return Type.BOOLEAN == source.type();
    }
