...
public final class SinKSchemaDouble implements SinkSchema {

    private static final SinkSchema INSTANCE = new SinKSchemaDouble();

    private static final Set<Type> TYPES = Sets.immutableEnumSet(Type.INT8, Type.INT16, Type.INT32, Type.INT64, Type.FLOAT32, Type.FLOAT64);
    ...
    public Object convertToJavaTypeValue(final Schema source, final Object recordValue) {
        ...
        return numberRecord.doubleValue();
    }
