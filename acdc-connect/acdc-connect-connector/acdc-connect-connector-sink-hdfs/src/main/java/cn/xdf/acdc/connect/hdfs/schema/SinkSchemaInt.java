...
public class SinkSchemaInt implements SinkSchema {

    private static final SinkSchema INSTANCE = new SinkSchemaInt();

    private static final Set<Type> TYPES = Sets.immutableEnumSet(Type.INT8, Type.INT16, Type.INT32);
