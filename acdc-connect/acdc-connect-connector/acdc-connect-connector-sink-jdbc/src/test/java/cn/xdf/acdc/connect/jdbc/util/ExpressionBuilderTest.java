...
public class ExpressionBuilderTest {
    ...
    protected void assertExpression(final String expected, final Consumer<ExpressionBuilder> builderFunction) {
    ...
    protected ExpressionBuilder builderWith(final IdentifierRules rules) {
