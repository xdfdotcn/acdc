...
import cn.xdf.acdc.connect.jdbc.dialect.GenericDatabaseDialect;
...
public class PreparedStatementBinderTest {
    ...
    @Test
    public void bindRecordInsert() throws SQLException {
        ...
        PrimaryKeyMode pkMode = PrimaryKeyMode.RECORD_VALUE;

        List<String> pkFields = Collections.singletonList("long");

        FieldsMetadata fieldsMetadata = FieldsMetadata
                .extract("people", pkMode, pkFields, Collections.emptySet(), schemaPair);
        ...
        verify(
                statement,
                times(1)
        ).setTimestamp(index++, new java.sql.Timestamp(((java.util.Date) valueStruct.get("timestamp")).getTime()),
                utcCalendar);
    ...
    public void bindRecordUpsertMode() throws SQLException, ParseException {
        ...
        FieldsMetadata fieldsMetadata = FieldsMetadata
                .extract("people", pkMode, pkFields, Collections.<String>emptySet(), schemaPair);
