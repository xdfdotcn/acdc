...
public class JdbcBufferedRecordsTest {
    ...
    public void setUp() throws IOException, SQLException {
        ...
        // sufficiently high to not cause flushes due to buffer being full
        ...
        props.put("destinations", "dummy");
        props.put("destinations.dummy.fields.whitelist", "name,age,id");
    }
    ...
    public void correctBatching() throws Exception {
        ...
        final JdbcBufferedRecords buffer = new JdbcBufferedRecords(config, tableId, dbDialect, dbStructure,
                sqliteHelper.getConnection());
    ...
    public void configParsingFailsIfDeleteWithWrongPKMode() {
        ...
        // wrong pk mode for deletes
        props.put("pk.mode", "kafka");
        new JdbcSinkConfig(props);
    }

    @Test
    public void insertThenDeleteInBatchNoFlush() throws Exception {
        props.put("delete.enabled", "true");
        props.put("insert.mode", "upsert");
    ...
    @Test
    public void insertThenTwoDeletesWithSchemaInBatchNoFlush() throws Exception {
        props.put("delete.enabled", "true");
        props.put("insert.mode", "upsert");
        props.put("pk.mode", "record_key");
        final JdbcSinkConfig config = new JdbcSinkConfig(props);
    ...
    @Test
    public void insertThenDeleteThenInsertInBatchFlush() throws Exception {
        props.put("delete.enabled", "true");
        props.put("insert.mode", "upsert");
        props.put("pk.mode", "record_key");
        final JdbcSinkConfig config = new JdbcSinkConfig(props);
    ...
    @Test
    public void insertThenDeleteWithSchemaThenInsertInBatchFlush() throws Exception {
        props.put("delete.enabled", "true");
        props.put("insert.mode", "upsert");
        props.put("pk.mode", "record_key");
        final JdbcSinkConfig config = new JdbcSinkConfig(props);
    ...
    @Test
    public void testMultipleDeletesBatchedTogether() throws Exception {
        props.put("delete.enabled", "true");
        props.put("insert.mode", "upsert");
        props.put("pk.mode", "record_key");
        final JdbcSinkConfig config = new JdbcSinkConfig(props);
    ...
    @Test
    public void testMultipleDeletesWithSchemaBatchedTogether() throws Exception {
        props.put("delete.enabled", "true");
        props.put("insert.mode", "upsert");
        props.put("pk.mode", "record_key");
        final JdbcSinkConfig config = new JdbcSinkConfig(props);
    ...
    @Test
    public void testFlushSuccessNoInfo() throws Exception {
        final String url = sqliteHelper.sqliteUri();
        final JdbcSinkConfig config = new JdbcSinkConfig(props);
        ...
        when(dbStructureMock.createOrAmendIfNecessary(Matchers.any(JdbcSinkConfig.class),
                ...
                .thenReturn(true);
        when(dbStructureMock.tableDefinition(Matchers.any(), Matchers.any())).thenReturn(tabDefMock);
    ...
    @Test
    public void testInsertModeUpdate() throws Exception {
        final String url = sqliteHelper.sqliteUri();
    ...
    @Test
    public void testAddRecordDeleteNotEnabledAndNonePkMode() throws Exception {
        props.put("pk.mode", "none");
    ...
    @Test
    public void testAddRecordDeleteNotEnabledAndRecordKeyPkMode() throws Exception {
        props.put("pk.mode", "record_key");
    ...
    @Test
    public void testAddRecordDeleteNotEnabledAndRecordValuePkMode() throws Exception {
    ...
    @Test
    public void testAddRecordDeleteNotEnabledAndKafkaPkMode() throws Exception {
        props.put("pk.mode", "kafka");
    ...
    @Test
    public void testAddRecordDeleteEnabledAndNonePkMode() {
        props.put("delete.enabled", "true");
        props.put("pk.mode", "none");
    ...
    @Test
    public void testAddRecordDeleteEnabledAndRecordValuePkMode() {
        props.put("delete.enabled", "true");
        props.put("pk.mode", "record_value");
        props.put("pk.fields", "name");
        ConfigException e = assertThrows(ConfigException.class, () -> new JdbcSinkConfig(props));
    ...
    @Test
    public void testAddRecordDeleteEnabledAndKafkaPkMode() {
        props.put("delete.enabled", "true");
        props.put("pk.mode", "kafka");
        ConfigException e = assertThrows(ConfigException.class, () -> new JdbcSinkConfig(props));
        assertEquals(
    ...
    @Test
    public void testAddRecordDeleteEnabledAndRecordKeyPkMode() throws Exception {
    ...
    protected SinkRecord generateRecord(
            final boolean includeKeySchema,
            final boolean includeKey,
            final boolean includeValueSchema,
    ...
    protected void assertInvalidRecord(
            ...
            final boolean includeValueSchema,
            final boolean includeValue,
            final String errorMessageFragment
    ) {
        assertInvalidRecord(
    ...
    protected void assertInvalidRecord(final SinkRecord record, final String errorMessageFragment) {
        final JdbcSinkConfig config = new JdbcSinkConfig(props);
    ...
    protected void assertValidRecord(final SinkRecord record) throws Exception {
