...
public class SapHanaDatabaseDialectTest extends BaseDialectTest<SapHanaDatabaseDialect> {
    ...
    public void shouldBuildCreateQueryStatement() {
        String expected =
                "CREATE COLUMN TABLE \"myTable\" (" + System.lineSeparator()
                        + "\"c1\" INTEGER NOT NULL," + System.lineSeparator()
                        + "\"c2\" BIGINT NOT NULL," + System.lineSeparator()
                        + "\"c3\" VARCHAR(1000) NOT NULL," + System.lineSeparator()
                        + "\"c4\" VARCHAR(1000) NULL," + System.lineSeparator()
    ...
    public void createOneColNoPk() {
        verifyCreateOneColNoPk("CREATE COLUMN TABLE \"myTable\" (" + System.lineSeparator() + "\"col1\" INTEGER NOT NULL)");
    }
    ...
    public void alterAddOneCol() {
        verifyAlterAddOneCol("ALTER TABLE \"myTable\" ADD(" + System.lineSeparator() + "\"newcol1\" INTEGER NULL)");
    }
