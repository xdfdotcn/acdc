...
public class TableTypeTest {
    ...
    private static final EnumSet<TableType> TABLE_ONLY = types(TableType.TABLE);

    private static final EnumSet<TableType> VIEW_ONLY = types(TableType.VIEW);

    private static final EnumSet<TableType> TABLE_AND_VIEW = types(TableType.TABLE, TableType.VIEW);

    protected static EnumSet<TableType> types(final TableType... types) {
        return EnumSet.copyOf(Arrays.asList(types));
    }

    protected static String[] array(final String... strs) {
        return strs;
    }
