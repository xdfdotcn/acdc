...
public class JdbcDriverInfo {
    ...
    /**
     * Determine if the JDBC driver supports at least the specified major and minor version of the JDBC specifications.
     * This can be used to determine whether or not to call JDBC methods.
     *
