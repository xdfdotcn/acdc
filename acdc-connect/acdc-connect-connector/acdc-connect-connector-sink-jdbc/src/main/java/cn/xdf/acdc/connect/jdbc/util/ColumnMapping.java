...
/**
 * A mapping of a {@link ColumnDefinition result set column definition} and a {@link Field} within a {@link Schema}.
 */
public class ColumnMapping {
    ...
    /**
     * Get the 1-based number of the column within the result set. This can be used to access the corresponding value
